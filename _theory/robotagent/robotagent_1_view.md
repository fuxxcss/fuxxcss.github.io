...
- 四级（L4），低技能操作：关键技术是视觉-语言-动作模型（VLA），VLA在VLM的基础上，增加了“动作”模态，可以直接输出操作指令，机器人不仅能走到任务地点，还能与环境进行有意义的互动：开门、拿杯子、搅拌锅里的食物、折叠毛巾。
...
- VLA，视觉语言行动模型[^3]，输入图像视频、文本，输出预测的行动，在RobotAgent中有很好的效果。
